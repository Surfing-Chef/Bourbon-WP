...
- Implemented WordPress plug-in based contact form - using php generated by plugin
  ...
  - Created contact form using the template offered, used only 5 generated fields:  
      - **Name** - cleared default and added class _contact-name_  
      - **Email** - cleared default and added class _contact-email_
      - **Subject** - cleared default and added class _contact-subject_
      - **Message** - cleared default and added class _contact-name_  
      - **Captcha** - cleared default and added class _contact-name_   
