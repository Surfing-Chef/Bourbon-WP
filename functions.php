...
function bourbon_wp_scripts() {
	wp_enqueue_style( 'bourbon-wp-style', get_stylesheet_uri() );
...
/**
* Displays category specific posts
*/
function bourbon_wp_postsbycategory($cat_slug) {
// the query
$the_query = new WP_Query( array( 'category_name' => $cat_slug, 'posts_per_page' => 10 ) );

// The Loop
if ( $the_query->have_posts() ) {

	// get_template_part( 'template-parts/content', 'cat-posts' );
	// REPLACE THE FOLLOWING WITH A CALL TO A TEMPLATE PART ABOVE
...
// Add a shortcode
add_shortcode('categoryposts', 'bourbon_wp_postsbycategory');
